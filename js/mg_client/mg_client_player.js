...
//				player = lookup_player(member.name);
    ...
    addTriggers("gift",{},[ // die 3 verschiedenen Actions sind zu Demo-Zwecken drin, damit man sieht wie highlight benutzt werden kann
		highlight({trigger:/Du hast keine Vergiftung./, style: {color:"green"},  action : function() { Player.poison = 1 }}),
		...
		highlight({trigger:/Du hast eine sehr ernste Vergiftung./, style: {color:"red", "font-weight" :"bold"},  action : "Player.poison = 3 "})
	]);
    /*
